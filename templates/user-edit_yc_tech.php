...
<?php
//add by YC-TECH
$yc_user_info = wp_get_current_user();
if($yc_user_info->roles[0] == 'administrator'):
?>
...
<tr class="user-display-name-wrap">
    ...
    <?php
    $profileuser_data = get_userdata($profileuser->ID);
    $profileuser_displayname = $profileuser_data->data->display_name;
    $profileuser_username = $profileuser_data->data->user_login;
    $display_name = (empty($profileuser_displayname))?$profileuser_username:$profileuser_displayname;
    ?>
    <input type="text" id="display_name" name="display_name" value="<?php echo $display_name; ?>" />
		</td>
	</tr>
	<tr class="user-user-login-wrap">
		<th><label for="user_login"><?php _e( 'Username' ); ?></label></th>
		<td><input type="text" name="user_login" id="user_login" value="<?php echo esc_attr( $profileuser->user_login ); ?>" disabled="disabled" class="regular-text" /> <span class="description"><?php _e( 'Usernames cannot be changed.' ); ?></span>
