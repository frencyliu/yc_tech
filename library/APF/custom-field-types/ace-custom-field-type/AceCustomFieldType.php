<?php
/**
 * yc_AceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'yc_AceCustomFieldType' ) ) :
class yc_AceCustomFieldType extends yc_AdminPageFramework_FieldType {
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.YC_TECH-field' ).nextAll().andSelf().each( function( iIndex ) {
