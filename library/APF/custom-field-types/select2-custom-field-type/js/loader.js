(function($){
    ...
    $( document ).ready( function(){
        ...
        if ( 'undefined' === typeof yc_AdminPageFrameworkSelect2FieldType ) {
            return;
        }
        debugLog( yc_AdminPageFrameworkSelect2FieldType );
        ...
        $().registeryc_AdminPageFrameworkCallbacks( {
            /**
    ...
    function initializeSelect2( oNode ) {
        ...
        if ( _aOptions[ 'search_callback' ] ) {
            ...
            _aOptions = $.extend(
                ...
                {
                    ajax: {
                        url: yc_AdminPageFrameworkSelect2FieldType.ajaxURL,
                        dataType: 'json',
                        ...
                        data: function (params) {
                            ...
                            return {
                                ...
                                doing_select2_ajax: yc_AdminPageFrameworkSelect2FieldType.nonce, // ensure it is called from here
    ...
    function debugLog( ...message ) {
        if ( ! parseInt( yc_AdminPageFrameworkSelect2FieldType.debugMode ) ) {
            return;
        }
