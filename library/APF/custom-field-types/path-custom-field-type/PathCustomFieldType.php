 ...
 * @package     yc_AdminPageFramework
 */

if ( ! class_exists( 'yc_PathCustomFieldType' ) ) :
/**
 ...
 */
class yc_PathCustomFieldType extends yc_AdminPageFramework_FieldType_image {
    ...
    protected function getScripts() {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery().registeryc_AdminPageFrameworkCallbacks( {
                /**
    ...
    public function getField( $aField ) {
        ...
        return
            $aField[ 'before_label' ]
            . "<div class='YC_TECH-input-label-container YC_TECH-input-container {$aField[ 'type' ]}-field'>" 
                . "<label for='{$aField[ 'input_id' ]}'>"
                    . $aField[ 'before_input' ]
                    . $this->getAOrB(
                        $aField[ 'label' ] && ! $aField[ 'repeatable' ],
                        "<span " . $this->getLabelContainerAttributes( $aField, 'YC_TECH-input-label-string' ) . ">" 
                            . $aField[ 'label' ] 
                        . "</span>",                        
                        ''                        
                    )
...
JAVASCRIPTS;
            ...
            return "<script type='text/javascript' class='YC_TECH-{$sType}-remove-button'>"
                    . '/* <![CDATA[ */'
                    . $_sScript 
                    . '/* ]]> */'
                . "</script>". PHP_EOL;
...
jQuery( document ).ready( function(){   
    //setyc_AdminPageFrameworkMediaUploader( '{$sInputID}', 'true' === '{$_sRpeatable}' );
});
JAVASCRIPTS;
                    
            return "<script type='text/javascript' class='YC_TECH-media-uploader-button'>" 
                    . '/* <![CDATA[ */'
                    . $_sScript 
                    . '/* ]]> */'
                . "</script>". PHP_EOL;
                ...
                return "<a " . $this->getAttributes( $_aAttributes ) . ">"
                        . $this->getAOrB( 
                            ...
                            $this->getAOrB(
                                ...
                                '',
                                __( 'Select Path', 'YC_TECH-field-type-pack' )
                            )
                        )
                    ."</a>";
