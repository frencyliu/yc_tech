<?php
if ( ! class_exists( 'yc_GitHubCustomFieldType' ) ) :
/**
 * @version     1.0.1
 */
class yc_GitHubCustomFieldType extends yc_AdminPageFramework_FieldType {
    ...
    protected function getField( $aField ) { 
        ...
        return 
            $aField['before_label']
            . "<div class='YC_TECH-input-label-container'>"        
                . $aField['before_input']
                . ( $aField['label'] && ! $aField['repeatable']
                    ? "<span class='YC_TECH-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label'] . "</span>"
                    : "" 
                )
        ...
        private function _getButtonLabelByType( $sButtonType, $sUserName, $sValue ) {
            ...
            switch( $sButtonType ) {
                case 'follow': 
                    return sprintf( __( 'Follow @%1$s', 'YC_TECH' ), $sUserName );
                case 'watch':
                    return __( 'Watch', 'YC_TECH' );
                case 'star':
                    return __( 'Star', 'YC_TECH' );
                case 'fork':
                    return __( 'Fork', 'YC_TECH' );
                case 'issue':
                    return __( 'Issue', 'YC_TECH' );
                default:
                    return '';
            }                 
