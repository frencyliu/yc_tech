...
abstract class yc_AdminPageFramework_TermMeta_Router extends yc_AdminPageFramework_TaxonomyField_Controller {
    }
    abstract class yc_AdminPageFramework_TermMeta_Model extends yc_AdminPageFramework_TermMeta_Router {
        ...
        private function _getSavedTermMetas($iTermID, array $aFieldsets) {
            $_oMetaData = new yc_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
    ...
    abstract class yc_AdminPageFramework_TermMeta_View extends yc_AdminPageFramework_TermMeta_Model {
    ...
    abstract class yc_AdminPageFramework_TermMeta_Controller extends yc_AdminPageFramework_TermMeta_View {
    }
    abstract class yc_AdminPageFramework_TermMeta extends yc_AdminPageFramework_TermMeta_Controller {
        protected $_sStructureType = 'term_meta';
        public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'yc_tech') {
