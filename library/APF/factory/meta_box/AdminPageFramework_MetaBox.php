...
abstract class yc_AdminPageFramework_MetaBox_Router extends yc_AdminPageFramework_Factory {
    protected $oResource;
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'YC_TECH') {
    ...
    abstract class yc_AdminPageFramework_MetaBox_Model extends yc_AdminPageFramework_MetaBox_Router {
        public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'YC_TECH') {
        ...
        public function _replyToGetSavedFormData() {
            $_oMetaData = new yc_AdminPageFramework_MetaBox_Model___PostMeta($this->___getPostID(), $this->oForm->aFieldsets);
    ...
    abstract class yc_AdminPageFramework_MetaBox_View extends yc_AdminPageFramework_MetaBox_Model {
    ...
    abstract class yc_AdminPageFramework_MetaBox_Controller extends yc_AdminPageFramework_MetaBox_View {
    ...
    abstract class yc_AdminPageFramework_MetaBox extends yc_AdminPageFramework_MetaBox_Controller {
