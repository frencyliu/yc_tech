...
abstract class yc_AdminPageFramework_PageMetaBox_Router extends yc_AdminPageFramework_MetaBox_View {
    protected $oResource;
    ...
    abstract class yc_AdminPageFramework_PageMetaBox_Model extends yc_AdminPageFramework_PageMetaBox_Router {
    ...
    abstract class yc_AdminPageFramework_PageMetaBox_View extends yc_AdminPageFramework_PageMetaBox_Model {
    }
    abstract class yc_AdminPageFramework_PageMetaBox_Controller extends yc_AdminPageFramework_PageMetaBox_View {
    ...
    abstract class yc_AdminPageFramework_PageMetaBox extends yc_AdminPageFramework_PageMetaBox_Controller {
        protected $_sStructureType = 'page_meta_box';
        public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'yc_tech') {
