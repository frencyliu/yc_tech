...
class yc_AdminPageFramework_Model__FormSubmission__Validator_Base extends yc_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    ...
    class yc_AdminPageFramework_Model__FormSubmission__Validator extends yc_AdminPageFramework_Model__FormSubmission__Validator_Base {
        public $oFactory;
        ...
        public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
            ...
            $_aClassNames = array('yc_AdminPageFramework_Model__FormSubmission__Validator__Link', 'yc_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'yc_AdminPageFramework_Model__FormSubmission__Validator__Import', 'yc_AdminPageFramework_Model__FormSubmission__Validator__Export', 'yc_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'yc_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'yc_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'yc_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
            ...
            try {
                ...
                $_oFormSubmissionFilter = new yc_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
