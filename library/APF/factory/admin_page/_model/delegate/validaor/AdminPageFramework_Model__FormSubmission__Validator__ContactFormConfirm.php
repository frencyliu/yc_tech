...
class yc_AdminPageFramework_Model__FormSubmission__Validator__ContactForm extends yc_AdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function ___sendEmail($aInputs, $sPressedInputNameFlat, $sSubmitSectionID) {
        ...
        $_oEmail = new yc_AdminPageFramework_FormEmail($_aEmailOptions, $aInputs, $sSubmitSectionID);
        $_bSent = $_oEmail->send();
    ...
    class yc_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm extends yc_AdminPageFramework_Model__FormSubmission__Validator__ContactForm {
        public $sActionHookPrefix = 'try_validation_after_';
