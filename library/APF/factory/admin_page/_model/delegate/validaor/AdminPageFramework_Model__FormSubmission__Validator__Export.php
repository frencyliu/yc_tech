...
class yc_AdminPageFramework_Model__FormSubmission__Validator__Import extends yc_AdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new yc_AdminPageFramework_ImportOptions($this->getHTTPRequestSanitized($_FILES['__import'], false), $this->getHTTPRequestSanitized($_POST['__import']));
    ...
    class yc_AdminPageFramework_Model__FormSubmission__Validator__Export extends yc_AdminPageFramework_Model__FormSubmission__Validator__Import {
        public $sActionHookPrefix = 'try_validation_after_';
        ...
        protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
            $_oExport = new yc_AdminPageFramework_ExportOptions($this->getHTTPRequestSanitized($this->getElementAsArray($_POST, array('__export'))), $this->oFactory->oProp->sClassName);
