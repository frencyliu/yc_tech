...
abstract class yc_AdminPageFramework_Model__FormSubmission_Base extends yc_AdminPageFramework_Form_Utility {
    ...
    class yc_AdminPageFramework_Model__FormSubmission extends yc_AdminPageFramework_Model__FormSubmission_Base {
        public $oFactory;
        public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            $this->oFactory = $oFactory;
            $this->_handleFormData();
            new yc_AdminPageFramework_Model__FormRedirectHandler($oFactory);
        }
        public function _handleFormData() {
            ...
            new yc_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
