...
abstract class yc_AdminPageFramework_CustomSubmitFields extends yc_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
    ...
    class yc_AdminPageFramework_ExportOptions extends yc_AdminPageFramework_CustomSubmitFields {
        public $sClassName;
        public $sFileName;
        public $sFormatType;
        public $bIsDataSet;
            ...
            switch (strtolower($sFormatType)) {
                case 'text':
                    if (in_array(gettype($vData), array('array', 'object'))) {
                        echo yc_AdminPageFramework_Debug::get($vData, null, false);
                    }
                    echo $vData;
                    return;
                case 'json':
