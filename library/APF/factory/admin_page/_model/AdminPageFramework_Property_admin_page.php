...
class yc_AdminPageFramework_Property_admin_page extends yc_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'YC_TECH') {
        ...
        $GLOBALS['ayc_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('ayc_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['ayc_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
