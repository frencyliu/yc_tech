...
abstract class yc_AdminPageFramework_Router extends yc_AdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'yc_tech') {
    ...
    public function _replyToLoadComponentsForAjax() {
        ...
        new yc_AdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
    ...
    abstract class yc_AdminPageFramework_Model_Form extends yc_AdminPageFramework_Router {
        public $aFieldErrors;
        ...
        public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            new yc_AdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
        }
    ...
    abstract class yc_AdminPageFramework_View_Form extends yc_AdminPageFramework_Model_Form {
    ...
    abstract class yc_AdminPageFramework_Controller_Form extends yc_AdminPageFramework_View_Form {
        ...
        public function getValue() {
            ...
            return yc_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
        }
    ...
    abstract class yc_AdminPageFramework_Model_Page extends yc_AdminPageFramework_Controller_Form {
        public function _replyToFinalizeInPageTabs() {
            ...
            foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
                ...
                $_oFormatter = new yc_AdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
    ...
    abstract class yc_AdminPageFramework_View_Page extends yc_AdminPageFramework_Model_Page {
        ...
        public function _replyToEnablePageMetaBoxes() {
            new yc_AdminPageFramework_View__PageMetaboxEnabler($this);
        }
        public function _replyToEnqueuePageAssets() {
            new yc_AdminPageFramework_View__Resource($this);
        }
        ...
        protected function _renderPage($sPageSlug, $sTabSlug = null) {
            $_oPageRenderer = new yc_AdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
            $_oPageRenderer->render();
        }
    }
    abstract class yc_AdminPageFramework_Controller_Page extends yc_AdminPageFramework_View_Page {
    ...
    abstract class yc_AdminPageFramework_Model_Menu extends yc_AdminPageFramework_Controller_Page {
        public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'yc_tech') {
            parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
            new yc_AdminPageFramework_Model_Menu__RegisterMenu($this);
        }
    }
    abstract class yc_AdminPageFramework_View_Menu extends yc_AdminPageFramework_Model_Menu {
    }
    abstract class yc_AdminPageFramework_Controller_Menu extends yc_AdminPageFramework_View_Menu {
        ...
        public function addSubMenuLink(array $aSubMenuLink) {
            ...
            $_oFormatter = new yc_AdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
        ...
        public function addSubMenuPage(array $aSubMenuPage) {
            ...
            $_oFormatter = new yc_AdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
            $_aSubMenuPage = $_oFormatter->get();
            $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
        }
    }
    abstract class yc_AdminPageFramework_Model extends yc_AdminPageFramework_Controller_Menu {
    }
    abstract class yc_AdminPageFramework_View extends yc_AdminPageFramework_Model {
        public function content($sContent) {
            return $sContent;
        }
    }
    abstract class yc_AdminPageFramework_Controller extends yc_AdminPageFramework_View {
        ...
        public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
            ...
            new yc_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, 'isInThePage'),));
        }
        ...
        static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
            return yc_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
        }
    }
    abstract class yc_AdminPageFramework extends yc_AdminPageFramework_Controller {
        protected $_sStructureType = 'admin_page';
        public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'yc_tech') {
        ...
        private function _getCallerPath($sCallerPath) {
            ...
            return 'plugins.php' === $GLOBALS['pagenow'] || isset($_GET['page']) ? yc_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
        }
    }
