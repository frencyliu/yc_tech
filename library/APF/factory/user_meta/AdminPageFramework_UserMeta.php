...
abstract class yc_AdminPageFramework_UserMeta_Router extends yc_AdminPageFramework_Factory {
    ...
    abstract class yc_AdminPageFramework_UserMeta_Model extends yc_AdminPageFramework_UserMeta_Router {
        public function _replyToGetSavedFormData() {
            $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
            $_oMetaData = new yc_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
    ...
    abstract class yc_AdminPageFramework_UserMeta_View extends yc_AdminPageFramework_UserMeta_Model {
    ...
    abstract class yc_AdminPageFramework_UserMeta_Controller extends yc_AdminPageFramework_UserMeta_View {
        public function setUp() {
        }
    }
    abstract class yc_AdminPageFramework_UserMeta extends yc_AdminPageFramework_UserMeta_Controller {
        protected $_sStructureType = 'user_meta';
        public function __construct($sCapability = 'read', $sTextDomain = 'YC_TECH') {
