...
abstract class yc_AdminPageFramework_PostType_Router extends yc_AdminPageFramework_Factory {
    ...
    abstract class yc_AdminPageFramework_PostType_Model extends yc_AdminPageFramework_PostType_Router {
        public function __construct($oProp) {
            parent::__construct($oProp);
            ...
            if ($this->oProp->bIsAdmin) {
                ...
                if ($this->oProp->sCallerPath) {
                    new yc_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
                }
            }
        }
        ...
        public function _replyToRegisterPostType() {
            ...
            new yc_AdminPageFramework_PostType_Model__SubMenuOrder($this);
        }
    ...
    abstract class yc_AdminPageFramework_PostType_View extends yc_AdminPageFramework_PostType_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            if ($this->oProp->bIsAdmin) {
        ...
        public function _replyToPrintStyle() {
            ...
            if (!empty($_sStyle)) {
                echo "<style type='text/css' id='yc_tech-style-post-type'>" . $this->oProp->sStyle . "</style>";
            }
            $this->oProp->sStyle = '';
        }
    ...
    abstract class yc_AdminPageFramework_PostType_Controller extends yc_AdminPageFramework_PostType_View {
    ...
    abstract class yc_AdminPageFramework_PostType extends yc_AdminPageFramework_PostType_Controller {
        protected $_sStructureType = 'post_type';
        public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'yc_tech') {
            if (empty($sPostType)) {
                return;
            }
            ...
            $this->oProp->sPostType = yc_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
            $this->oProp->aPostTypeArgs = $aArguments;
        ...
        private function _getCallerScriptPath($sCallerPath) {
            ...
            $_sPageNow = yc_AdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
            if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
                return yc_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
            }
            return null;
        }
    }
