...
class yc_AdminPageFramework_FieldType_taxonomy extends yc_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new yc_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        return parent::getScripts() . <<<JAVASCRIPTS
/* For tabs */
var enableyc_AdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enableyc_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registeryc_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Initialize
            enableyc_AdminPageFrameworkTabbedBox( oCloned.find( '.tab-box-container' ) );
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".YC_TECH-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.YC_TECH-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.YC_TECH-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.YC_TECH-field .taxonomy-checklist ul ul {margin-left: 1em;}.YC_TECH-field .taxonomy-checklist-label {white-space: nowrap; }.YC_TECH-field .tab-box-container.categorydiv {max-height: none;}.YC_TECH-field .tab-box-tab-text {display: inline-block;font-size: 13px;font-size: smaller;padding: 2px;}.YC_TECH-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.YC_TECH-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 4px;background-color: #fff;}.YC_TECH-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.YC_TECH-field .tab-box-tabs li a { color: #333; text-decoration: none; }.YC_TECH-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.YC_TECH-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.YC_TECH-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.YC_TECH-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.YC_TECH-field .tab-box-content:target, .YC_TECH-field .tab-box-content:target, .YC_TECH-field .tab-box-content:target { display: block; }.YC_TECH-field .tab-box-content .select_all_button_container, .YC_TECH-field .tab-box-content .select_none_button_container{display: inline-block;margin-top: 0.8em;}.YC_TECH-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
