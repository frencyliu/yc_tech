...
class yc_AdminPageFramework_FieldType_radio extends yc_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".yc_tech-field input[type='radio'] {margin-right: 0.5em;} .yc_tech-field-radio .yc_tech-input-label-container {padding-right: 1em;} .yc_tech-field-radio .yc_tech-input-container {display: inline;} .yc_tech-field-radio .yc_tech-input-label-string{display: inline; }";
    }
    ...
    jQuery().registeryc_AdminPageFrameworkCallbacks( { 
        ...
        repeated_field: function( oCloned, aModel ) {            
            oCloned.find( 'input[type=radio]' )
                ...
                jQuery( this ).closest( '.yc_tech-field' ).find( 'input[type=radio]' )
                    .prop( 'checked', false )
                    .attr( 'checked', false ); 
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).on( 'change', function( e ) {
        ...
        // Uncheck the other radio buttons
        jQuery( this ).closest( '.yc_tech-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' )
            .prop( 'checked', false )
            .attr( 'checked', false );
