...
class yc_AdminPageFramework_FieldType_import extends yc_AdminPageFramework_FieldType_submit {
...
jQuery( document ).ready( function() {
    jQuery( '.yc_tech-field-import input[type=submit]' ).on( 'click', function( event ) {
        var _iFiles = jQuery( this ).closest( '.yc_tech-field-import' ).find( 'input[type=file]' ).get( 0 ).files.length;
        if ( 0 === _iFiles ) {
...
JAVASCRIPT;
    ...
    protected function getStyles() {
        return ".yc_tech-field-import input {margin-right: 0.5em;}.yc_tech-field-import,.yc_tech-field-import .yc_tech-input-label-container {width: 100%;}.yc_tech-field-import label,.form-table td fieldset.yc_tech-fieldset .yc_tech-field-import label { display: inline-block; width: auto;vertical-align: middle;}";
    }
