...
class yc_AdminPageFramework_FieldType_checkbox extends yc_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.YC_TECH-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.YC_TECH-checkbox-label {margin-top: 0.1em;}.YC_TECH-field input[type='checkbox' ] {margin-right: 0.5em;} .YC_TECH-field-checkbox .YC_TECH-input-label-container {padding-right: 1em;}.YC_TECH-field-checkbox .YC_TECH-input-label-string{display: inline; }";
    }
    ...
    class yc_AdminPageFramework_FieldType_posttype extends yc_AdminPageFramework_FieldType_checkbox {
        ...
        protected function getStyles() {
            ...
            return $_sParentStyles . ".YC_TECH-field input[type='checkbox'] {margin-right: 0.5em;} .YC_TECH-field-posttype .YC_TECH-input-label-container {padding-right: 1em;}";
        }
        protected function getField($aField) {
