...
class yc_AdminPageFramework_FieldType_submit extends yc_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".YC_TECH-field input[type='submit'] {margin-bottom: 0.5em;}.YC_TECH-field-submit .submit-confirm-container {display: inline-block;margin-left: 1em;vertical-align: middle;}.YC_TECH-field-submit .field-error.submit-confirmation-warning {float: none;}";
    }
    protected function getScripts() {
        return <<<JAVASCRIPTS
jQuery( document ).ready( function(){
    jQuery( '.YC_TECH-field-submit .submit-confirm-container input[type=checkbox]' ).each( function( index, value ){
        jQuery( this ).closest( '.YC_TECH-field-submit' ).find( 'input[type=submit]' ).on( 'click', function( event ){
            var _fieldSubmit = jQuery( this ).closest( '.YC_TECH-field-submit' );  
            _fieldSubmit.find( '.submit-confirmation-warning' ).remove(); // previous error message
            var _confirmCheckbox = jQuery( this ).closest( '.YC_TECH-field-submit' ).find( '.submit-confirm-container input[type=checkbox]' );
...
JAVASCRIPTS;
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'YC_TECH-input-label-container' . ' YC_TECH-input-button-container' . ' YC_TECH-input-container',);
    }
    ...
    class yc_AdminPageFramework_FieldType_export extends yc_AdminPageFramework_FieldType_submit {
