...
class yc_AdminPageFramework_Form_Model___Format_RepeatableSection extends yc_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : yc_AdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class yc_AdminPageFramework_Form_Model___Format_RepeatableField extends yc_AdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {
