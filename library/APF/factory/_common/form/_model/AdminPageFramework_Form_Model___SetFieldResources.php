...
class yc_AdminPageFramework_Form_Model___SetFieldResources extends yc_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new yc_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('yc_AdminPageFramework_Form_View___CSS_Form', 'yc_AdminPageFramework_Form_View___CSS_Field', 'yc_AdminPageFramework_Form_View___CSS_Section', 'yc_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'yc_AdminPageFramework_Form_View___CSS_FieldError', 'yc_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('yc_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new yc_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new yc_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
