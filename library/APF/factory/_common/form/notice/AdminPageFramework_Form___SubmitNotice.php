...
class yc_AdminPageFramework_Form___SubmitNotice extends yc_AdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new yc_AdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new yc_AdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
    }
