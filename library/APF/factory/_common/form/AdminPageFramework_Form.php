...
abstract class yc_AdminPageFramework_Form_Utility extends yc_AdminPageFramework_FrameworkUtility {
    ...
    static public function getFieldsetReformattedBySubFieldIndex($aFieldset, $iSubFieldIndex, $bHasSubFields, $aParentFieldset) {
        ...
        $_oFieldsetFormatter = new yc_AdminPageFramework_Form_Model___Format_Fieldset($aFieldset, $aFieldset['_structure_type'], $aFieldset['capability'], ( integer )$iSubFieldIndex + 1, $aFieldset['_subsection_index'], $aFieldset['_is_section_repeatable'], $aFieldset['_caller_object']);
        $aFieldset = $_oFieldsetFormatter->get();
        $_oFieldsetOutputFormatter = new yc_AdminPageFramework_Form_Model___Format_FieldsetOutput($aFieldset, $aFieldset['_section_index'], $_oCallerForm->aFieldTypeDefinitions);
    ...
    abstract class yc_AdminPageFramework_Form_Base extends yc_AdminPageFramework_Form_Utility {
    ...
    class yc_AdminPageFramework_Form_Model extends yc_AdminPageFramework_Form_Base {
        public $aArguments;
        ...
        public function getSortedInputs(array $aFormInputs) {
            ...
            $_oInputSorter = new yc_AdminPageFramework_Form_Model___Modifier_SortInput($aFormInputs, $_aDynamicFieldAddressKeys);
        ...
        public function dropRepeatableElements(array $aSubject) {
            $_oFilterRepeatableElements = new yc_AdminPageFramework_Form_Model___Modifier_FilterRepeatableElements($aSubject, $this->getHTTPRequestSanitized($this->getElementAsArray($_POST, '__repeatable_elements_' . $this->aArguments['structure_type'])));
        ...
        public function _replyToRegisterFormItems() {
            ...
            $_oFieldResources = new yc_AdminPageFramework_Form_Model___SetFieldResources($this->aArguments, $this->aFieldsets, self::$_aResources, $this->aFieldTypeDefinitions, $this->aCallbacks);
        ...
        private function _setSiteWideFieldTypeDefinitions() {
            ...
            $_oBuiltInFieldTypeDefinitions = new yc_AdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions('admin_page_framework', $this->oMsg);
        ...
        public function getDefaultFormValues() {
            $_oDefaultValues = new yc_AdminPageFramework_Form_Model___DefaultValues($this->aFieldsets);
            return $_oDefaultValues->get();
        }
        protected function _formatElementDefinitions(array $aSavedData) {
            $_oSectionsetsFormatter = new yc_AdminPageFramework_Form_Model___FormatSectionsets($this->aSectionsets, $this->aArguments['structure_type'], $this->sCapability, $this->aCallbacks, $this);
            $this->aSectionsets = $_oSectionsetsFormatter->get();
            $_oFieldsetsFormatter = new yc_AdminPageFramework_Form_Model___FormatFieldsets($this->aFieldsets, $this->aSectionsets, $this->aArguments['structure_type'], $this->aSavedData, $this->sCapability, $this->aCallbacks, $this);
    ...
    class yc_AdminPageFramework_Form_View extends yc_AdminPageFramework_Form_Model {
        public function __construct() {
            parent::__construct();
            new yc_AdminPageFramework_Form_View__Resource($this);
        }
        public function get() {
        ...
        private function _getNoScriptMessage() {
            ...
            return "<noscript>" . "<div class='error'>" . "<p class='yc_tech-form-warning'>" . $this->oMsg->get('please_enable_javascript') . "</p>" . "</div>" . "</noscript>";
        }
        public function printSubmitNotices() {
            $this->oSubmitNotice->render();
        }
    }
    class yc_AdminPageFramework_Form_Controller extends yc_AdminPageFramework_Form_View {
    ...
    class yc_AdminPageFramework_Form extends yc_AdminPageFramework_Form_Controller {
        ...
        public $aSubClasses = array('submit_notice' => 'yc_AdminPageFramework_Form___SubmitNotice', 'field_error' => 'yc_AdminPageFramework_Form___FieldError', 'last_input' => 'yc_AdminPageFramework_Form_Model___LastInput', 'message' => 'yc_AdminPageFramework_Message',);
        public function __construct() {
