...
abstract class yc_AdminPageFramework_Form_View___Generate_Field_Base extends yc_AdminPageFramework_Form_View___Generate_Section_Base {
    ...
    class yc_AdminPageFramework_Form_View___Generate_FieldName extends yc_AdminPageFramework_Form_View___Generate_Field_Base {
        public function get() {
    ...
    class yc_AdminPageFramework_Form_View___Generate_FlatFieldName extends yc_AdminPageFramework_Form_View___Generate_FieldName {
        public function get() {
    ...
    class yc_AdminPageFramework_Form_View___Generate_FieldAddress extends yc_AdminPageFramework_Form_View___Generate_FlatFieldName {
        public function get() {
