...
class yc_AdminPageFramework_Form_View___Generate_FieldTagID extends yc_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
    ...
    class yc_AdminPageFramework_Form_View___Generate_FieldInputID extends yc_AdminPageFramework_Form_View___Generate_FieldTagID {
        public $isIndex = '';
