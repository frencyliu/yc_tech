...
class yc_AdminPageFramework_Form_View___Generate_FieldInputName extends yc_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public $sIndex = '';
    ...
    class yc_AdminPageFramework_Form_View___Generate_FlatFieldInputName extends yc_AdminPageFramework_Form_View___Generate_FieldInputName {
        public function get() {
            $_sIndex = $this->getAOrB('0' !== $this->sIndex && empty($this->sIndex), '', "|{$this->sIndex}");
