...
class yc_AdminPageFramework_Form_View___FieldTitle extends yc_AdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_oInputTagIDGenerator = new yc_AdminPageFramework_Form_View___Generate_FieldInputID($aField, 0);
        $_aLabelAttributes = array('class' => $this->getClassAttribute('yc_tech-field-title', $this->aClassSelectors), 'for' => $_oInputTagIDGenerator->get(),);
    ...
    private function _getFieldOutputsInFieldTitleAreaFromNestedFields($aField) {
        ...
        foreach ($aField['content'] as $_aNestedField) {
            ...
            $_oFieldset = new yc_AdminPageFramework_Form_View___Fieldset($_aNestedField, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
            $_sOutput.= $_oFieldset->get();
        }
        return $_sOutput;
    }
    private function _getToolTip($asTip, $sElementID) {
        $_oToolTip = new yc_AdminPageFramework_Form_View___ToolTip($asTip, $sElementID);
