...
class yc_AdminPageFramework_Form_View___Description extends yc_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'yc_tech-form-element-description';
