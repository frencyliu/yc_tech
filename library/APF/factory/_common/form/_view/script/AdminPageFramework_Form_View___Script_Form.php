...
class yc_AdminPageFramework_Form_View___Script_Form extends yc_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeyc_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.YC_TECH-form-loading' ).remove();
        jQuery( '.YC_TECH-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.YC_TECH-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removeyc_AdminPageFrameworkLoadingOutputs();
