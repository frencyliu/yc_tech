...
class yc_AdminPageFramework_Form_View___Script_SectionTab extends yc_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.yc_tech-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='yc_tech-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
