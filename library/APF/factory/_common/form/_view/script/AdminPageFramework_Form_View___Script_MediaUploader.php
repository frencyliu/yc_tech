...
class yc_AdminPageFramework_Form_View___Script_MediaUploader extends yc_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
    ...
    getyc_AdminPageFrameworkCustomMediaUploaderSelectObject = function() {
