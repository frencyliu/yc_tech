...
class yc_AdminPageFramework_Form_View___DebugInfo extends yc_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='yc_tech-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
