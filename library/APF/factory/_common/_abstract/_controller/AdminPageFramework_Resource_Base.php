...
abstract class yc_AdminPageFramework_Resource_Base extends yc_AdminPageFramework_FrameworkUtility {
    ...
    protected $_sClassSelector_Style = 'YC_TECH-style';
    protected $_sClassSelector_Script = 'YC_TECH-script';
    ...
    private function ___getCommonStyleTag($oCaller, $sIDPrefix) {
        $_sStyle = $this->addAndApplyFilters($oCaller, array("style_common_admin_page_framework", "style_common_{$this->oProp->sClassName}",), yc_AdminPageFramework_CSS::getDefaultCSS());
    ...
    private function ___getCommonIEStyleTag($oCaller, $sIDPrefix) {
        $_sStyleIE = $this->addAndApplyFilters($oCaller, array("style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}",), yc_AdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName) {
        ...
        $_sScript = $this->addAndApplyFilters($this->oProp->oCaller, array("script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}",), yc_AdminPageFramework_Property_Base::$_sDefaultScript);
    ...
    public function _replyToAddStyle() {
        ...
        $this->_printCommonStyles('YC_TECH-style-common', get_class());
    ...
    public function _replyToAddScript() {
        ...
        $this->_printCommonScripts('YC_TECH-script-common', get_class());
