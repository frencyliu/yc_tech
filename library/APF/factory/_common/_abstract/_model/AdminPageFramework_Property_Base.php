...
abstract class yc_AdminPageFramework_Property_Base extends yc_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'yc_tech' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['ayc_AdminPageFramework'])) {
            $GLOBALS['ayc_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => yc_AdminPageFramework_Registry::NAME, 'sURI' => yc_AdminPageFramework_Registry::URI, 'sScriptName' => yc_AdminPageFramework_Registry::NAME, 'sLibraryName' => yc_AdminPageFramework_Registry::NAME, 'sLibraryURI' => yc_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => yc_AdminPageFramework_Registry::getVersion(), 'sDescription' => yc_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => yc_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => yc_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => yc_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => yc_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new yc_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
    }
