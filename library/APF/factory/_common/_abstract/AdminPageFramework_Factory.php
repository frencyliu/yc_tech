...
abstract class yc_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'yc_AdminPageFramework_Form_', 'oPageLoadInfo' => 'yc_AdminPageFramework_PageLoadInfo_', 'oResource' => 'yc_AdminPageFramework_Resource_', 'oHelpPane' => 'yc_AdminPageFramework_HelpPane_', 'oLink' => 'yc_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'yc_AdminPageFramework_Debug', 'oUtil' => 'yc_AdminPageFramework_FrameworkUtility', 'oMsg' => 'yc_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(yc_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return yc_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
    ...
    abstract class yc_AdminPageFramework_Factory_Model extends yc_AdminPageFramework_Factory_Router {
        public function __construct($oProp) {
    ...
    abstract class yc_AdminPageFramework_Factory_View extends yc_AdminPageFramework_Factory_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            new yc_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
        }
    ...
    abstract class yc_AdminPageFramework_Factory_Controller extends yc_AdminPageFramework_Factory_View {
    ...
    abstract class yc_AdminPageFramework_Factory extends yc_AdminPageFramework_Factory_Controller {
    }
