...
class yc_AdminPageFramework_AdminNotice extends yc_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'YC_TECH-settings-notice-message', 'YC_TECH-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new yc_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
