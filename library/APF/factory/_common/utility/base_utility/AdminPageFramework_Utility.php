...
abstract class yc_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        yc_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return yc_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        yc_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return yc_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        yc_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        yc_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        yc_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'yc_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
    ...
    abstract class yc_AdminPageFramework_Utility_VariableType extends yc_AdminPageFramework_Utility_Deprecated {
    ...
    abstract class yc_AdminPageFramework_Utility_String extends yc_AdminPageFramework_Utility_VariableType {
    ...
    abstract class yc_AdminPageFramework_Utility_Array extends yc_AdminPageFramework_Utility_String {
    ...
    abstract class yc_AdminPageFramework_Utility_ArrayGetter extends yc_AdminPageFramework_Utility_Array {
    ...
    abstract class yc_AdminPageFramework_Utility_ArraySetter extends yc_AdminPageFramework_Utility_ArrayGetter {
    ...
    abstract class yc_AdminPageFramework_Utility_Path extends yc_AdminPageFramework_Utility_ArraySetter {
    ...
    abstract class yc_AdminPageFramework_Utility_URL extends yc_AdminPageFramework_Utility_Path {
    ...
    abstract class yc_AdminPageFramework_Utility_File extends yc_AdminPageFramework_Utility_URL {
    ...
    abstract class yc_AdminPageFramework_Utility_SystemInformation extends yc_AdminPageFramework_Utility_File {
    ...
    abstract class yc_AdminPageFramework_Utility_HTMLAttribute extends yc_AdminPageFramework_Utility_SystemInformation {
    ...
    class yc_AdminPageFramework_Utility extends yc_AdminPageFramework_Utility_HTMLAttribute {
