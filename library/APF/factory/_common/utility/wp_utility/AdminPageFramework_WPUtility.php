...
class yc_AdminPageFramework_WPUtility_URL extends yc_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(yc_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(yc_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        if (false !== strpos($sFilePath, $_sContentDirPath)) {
            $_sRelativePath = yc_AdminPageFramework_Utility::getRelativePath(WP_CONTENT_DIR, $sFilePath);
            $_sRelativePath = preg_replace("/^\.[\/\\\]/", '', $_sRelativePath, 1);
            return content_url($_sRelativePath);
        }
        $_sRelativePath = yc_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
        $_sRelativePath = preg_replace("/^\.[\/\\\]/", '', $_sRelativePath, 1);
    ...
    class yc_AdminPageFramework_WPUtility_HTML extends yc_AdminPageFramework_WPUtility_URL {
    ...
    class yc_AdminPageFramework_WPUtility_Page extends yc_AdminPageFramework_WPUtility_HTML {
    ...
    class yc_AdminPageFramework_WPUtility_Hook extends yc_AdminPageFramework_WPUtility_Page {
    ...
    class yc_AdminPageFramework_WPUtility_File extends yc_AdminPageFramework_WPUtility_Hook {
    ...
    class yc_AdminPageFramework_WPUtility_Option extends yc_AdminPageFramework_WPUtility_File {
    ...
    class yc_AdminPageFramework_WPUtility_Meta extends yc_AdminPageFramework_WPUtility_Option {
    ...
    class yc_AdminPageFramework_WPUtility_SiteInformation extends yc_AdminPageFramework_WPUtility_Meta {
    ...
    class yc_AdminPageFramework_WPUtility_SystemInformation extends yc_AdminPageFramework_WPUtility_SiteInformation {
    ...
    class yc_AdminPageFramework_WPUtility extends yc_AdminPageFramework_WPUtility_SystemInformation {
