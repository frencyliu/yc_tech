...
class yc_AdminPageFramework_Debug_Base extends yc_AdminPageFramework_FrameworkUtility {
    ...
    class yc_AdminPageFramework_Debug_Log extends yc_AdminPageFramework_Debug_Base {
    ...
    class yc_AdminPageFramework_Debug extends yc_AdminPageFramework_Debug_Log {
        ...
        static public function dumpArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('yc_AdminPageFramework_Debug::' . __FUNCTION__, 'yc_AdminPageFramework_Debug::dump()');
            yc_AdminPageFramework_Debug::dump($asArray, $sFilePath);
        }
        static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
            self::showDeprecationNotice('yc_AdminPageFramework_Debug::' . __FUNCTION__, 'yc_AdminPageFramework_Debug::get()');
            return yc_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
        }
        static public function logArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('yc_AdminPageFramework_Debug::' . __FUNCTION__, 'yc_AdminPageFramework_Debug::log()');
            yc_AdminPageFramework_Debug::log($asArray, $sFilePath);
        }
        static public function getAsString($mValue) {
            self::showDeprecationNotice('yc_AdminPageFramework_Debug::' . __FUNCTION__);
