...
abstract class yc_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('yc_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new yc_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
